...
const Banner = () => {
    return (
        <div className='items-center relative bg-slate-200'>
            <div className='flex flex-col z-10 justify-start h-[600px] gap-8 items-center rounded-b-2xl p-10 bg-[#9538E2]'>
                ...
                <button className='text-xl font-bold p-2 px-5 rounded-full bg-[#FFFFFF] text-[#9538E2]'>Shop Now</button>
            </div>
            <div className='rounded-2xl p-3 z-30 w-[400px] md:w-[580px] lg:w-[800px] static mt-[-250px] ml-[180px] border bg-transparent'>
